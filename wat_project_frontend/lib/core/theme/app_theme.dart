...
class AppTheme {
  ...
  static ThemeData get dark => ThemeData(
        ...
        elevatedButtonTheme: _buildButtonTheme(AppColors.primary, AppColors.blackText),
        bottomNavigationBarTheme: _buildNavBarTheme(AppColors.secondary),
        appBarTheme: _buildAppBarTheme(),
        cardTheme: _buildCardTheme(),
      );
  ...
  static TextTheme _buildTextTheme(Color bodyColor) => TextTheme(
        displayLarge: TextStyle(color: bodyColor, fontSize: 32, fontWeight: FontWeight.bold),
