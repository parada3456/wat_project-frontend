...
abstract class ApiModule {
  ...
  @lazySingleton
  MissionApiService missionApi(@Named('mainDio') Dio dio) =>
      MissionApiService(dio);

  @lazySingleton
  JourneyApiService journeyApi(@Named('mainDio') Dio dio) =>
      JourneyApiService(dio);

  @lazySingleton
  FriendApiService friendApi(@Named('mainDio') Dio dio) =>
      FriendApiService(dio);

  @lazySingleton
  ExpenseApiService expenseApi(@Named('mainDio') Dio dio) =>
      ExpenseApiService(dio);

  @lazySingleton
  NotificationApiService notificationApi(@Named('mainDio') Dio dio) =>
      NotificationApiService(dio);
