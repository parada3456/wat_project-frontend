...
class _AdminApiService implements AdminApiService {
  ...
  Future<AdminStatsEntity> getStats() async {
    ...
    final _options = _setStreamType<AdminStatsEntity>(
    ...
    late AdminStatsEntity _value;
    try {
      _value = AdminStatsEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<PointsAdjustmentResultEntity> adjustPoints(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PointsAdjustmentResultEntity _value;
    try {
      _value = PointsAdjustmentResultEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
