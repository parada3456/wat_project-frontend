...
class ListJobReviewsSuccess extends JobMarketState {
  final List<JobReviewEntity> reviews;
  const ListJobReviewsSuccess(this.reviews);
}

class UpdateCartStatusSuccess extends JobMarketState {
  const UpdateCartStatusSuccess();
}
