...
part of 'friend_api_client.dart';
...
class _FriendApiService implements FriendApiService {
  ...
  @override
  Future<void> respondToRequest(String id, Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<List<RadarEntry>> getRadar() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<RadarEntry>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'radar',
    ...
    late List<RadarEntry> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => RadarEntry.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
