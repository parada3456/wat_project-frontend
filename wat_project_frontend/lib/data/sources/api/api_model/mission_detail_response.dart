...
import 'package:wat_project_frontend/data/entities/task_entity.dart';
import 'package:wat_project_frontend/data/entities/user_task_entity.dart';
...
class MissionDetailResponse {
  ...
  factory MissionDetailResponse.fromJson(Map<String, dynamic> json) {
    ...
    final userTasks = (json['tasks'] as List<dynamic>?)
            ?.map((e) => UserTaskEntity.fromJson(e as Map<String, dynamic>))
            .toList() ?? [];
